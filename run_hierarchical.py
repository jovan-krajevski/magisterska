...
for shrinkage_strength in [100, 10, 50, 500, 1000]:
    ...
    for point in pd.date_range("2015-01-01", "2017-01-01"):
        ...
        trend = LinearTrend()
        yearly = FourierSeasonality(365.25, 10, shrinkage_strength=shrinkage_strength)
        weekly = FourierSeasonality(7, 3, shrinkage_strength=shrinkage_strength)
        ...
        maps = pd.DataFrame.from_records([model.map_approx], index=[0])
        maps.to_csv(maps_path)
