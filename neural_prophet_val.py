...
train_df_smp, val_df_smp, scales_smp = generate_train_test_df_around_point(
    window=365 * 40, horizon=3 * N_FORECASTS, dfs=smp, for_prophet=False, point=points
)
train_df_tickers, val_df_tickers, scales_tickers = generate_train_test_df_around_point(
